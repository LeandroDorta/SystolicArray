...
proc edit_core {core} {
  ...
  ::ipx::associate_bus_interfaces -busif "input_matrix" -clock "ap_clk" $core
  ::ipx::associate_bus_interfaces -busif "weight_matrix" -clock "ap_clk" $core
  ::ipx::associate_bus_interfaces -busif "output_matrix" -clock "ap_clk" $core
  ...
  set reg      [::ipx::add_register -quiet "input_matrix" $addr_block]
  set_property address_offset 0x020 $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg] 
  set_property value m00_axi $regparam 

  set reg      [::ipx::add_register -quiet "weight_matrix" $addr_block]
  set_property address_offset 0x02c $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg] 
  set_property value m01_axi $regparam 

  set reg      [::ipx::add_register -quiet "output_matrix" $addr_block]
